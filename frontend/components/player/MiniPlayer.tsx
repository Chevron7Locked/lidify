            ...
            {isMobileOrTablet && isCollapsed && hasMedia && (
                ...
                >
                    ...
                    <button
                        ...
                        className="w-7 h-7 rounded-full bg-white text-black flex items-center justify-center hover:scale-105 transition ml-2"
            ...
            >
                ...
                <div
                    className={cn(
                        ...
                        hasMedia ? "cursor-pointer group hover:h-2" : "cursor-not-allowed"
                    )}
                    onClick={hasMedia ? handleProgressClick : undefined}
                    title={hasMedia ? "Click to seek" : undefined}
                >
                    <div
                        className={cn(
                            "h-full rounded-full relative transition-all duration-150",
                            hasMedia ? "bg-white" : "bg-gray-600"
                        )}
