...
import { Loader2, Server, CheckCircle, XCircle, Wifi } from "lucide-react";
    ...
    return (
        <div className="min-h-screen w-full relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[#0a0a0a] via-purple-900/20 to-[#0a0a0a]">
                {/* Yellow to purple gradient overlay matching main site */}
            ...
            <div className="relative z-20 min-h-screen flex items-center justify-center p-4">
                <div className="w-full max-w-md">
                    ...
                    {/* Login Card */}
                    <div className="bg-black/40 backdrop-blur-2xl rounded-2xl p-8 md:p-10 border border-white/10 shadow-2xl">
                        {isCheckingConfig ? (
                                ...
                                <div className="animate-fade-in space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            autoCapitalize="none"
                                            autoCorrect="off"
                                            className="w-full px-4 py-3 bg-white/5 border border-purple-500/30 rounded-lg text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent transition-all duration-200 backdrop-blur-sm text-center text-2xl tracking-widest"
                                        />
                            ...
                            <button
                                ...
                                className="w-full py-3.5 bg-white text-black font-bold rounded-full hover:scale-105 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 shadow-2xl hover:shadow-white/30 relative group overflow-hidden"
                            >
