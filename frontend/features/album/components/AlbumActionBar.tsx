import { Play, Pause, Shuffle, Download, ListPlus, ExternalLink } from "lucide-react";
            ...
            {isOwned && (
                <div className="flex items-center gap-3">
                    <button
                        ...
                        title={showPause ? "Pause" : "Play all"}
                    >
                        {showPause ? (
                            <Pause className="w-6 h-6 md:w-7 md:h-7 fill-current text-black" />
                        ) : (
